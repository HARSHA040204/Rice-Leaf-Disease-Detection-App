...
class narrowbrown extends StatelessWidget {
  @override
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: AssetImage('assets/images/narrow_brown (16).jpg'),
                fit: BoxFit.cover,
              ),
            ),
            child: const Padding(
          ...
          const Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                Text(
                  '• Elongated, brown lesions with a yellow halo develop on leaves.\n• Spots may merge, causing extensive leaf damage.',
                ...
                SizedBox(height: 5),
                Text(
                  '• Preventive measures are crucial. Use certified disease-free seeds. Apply preventative fungicide sprays containing tricyclazole or tebuconazole.',
                  style: TextStyle(fontSize: 16),
                ),
              ],
            ),
